...
const styles = StyleSheet.create({
  ...
  // Claymorphism search box - soft clay with inner shadow
  searchBox: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  // Claymorphism image card - floating 3D clay tile
  imageCard: {
    width: ITEM_SIZE,
    height: ITEM_SIZE,
    borderRadius: borderRadius.clayCard,
  ...
  // Claymorphism loading box - floating 3D clay tile
  loadingBox: {
    padding: spacing.lg,
    backgroundColor: colors.cardSurface,
    borderRadius: borderRadius.clayCard,
